...
public abstract class QTMessage {
    ...
    public enum type { EVENT, SYNC_POSITION, SYNC_ROTATION, HEARTBEAT, REQUEST_HEARTBEAT, INPUT, SPAWN, READY, REQUEST_SYNC, OWNER, SESSION, DESPAWN, INPUT_AXIS, REQUEST_ROOMS, ROOMS, WORKER_INFO, WORKER_DEBUG, SYNC_FIELD, CALL_FUNCTION, ROOM_INFO, WORKER_READY, SYNC_ANIMATION, CLIENT_INFO, VR_ACTION, SYNC_VR_POSITION, SYNC_VR_ROTATION }
