    ...
    half3 AnisotropicSpecular(
        ...
        float anisoSpec1Alpha, float anisoSpec2Alpha, float4 specularTint, float specularMixAlbedoIntoTint, float4 specularMap, float3 specularLight, float3 lightDirection, float3 halfDir, float nDotL)
    {
    ...
    float3 calculateSpecular(in float4 albedo)
    {
        ...
        if (_SpecularType == 1) // Realistic
        {
            ...
            if(_SpecularInvertSmoothness)
            {
                ...
                finalSpecular += calculateNewSpecular(specularMap.rgb, _SmoothnessFrom, realisticAlbedo, _SpecularTint, _SpecularMetallic, _SpecularSmoothness * specularMap.a, poiLight.dotNH, poiLight.dotLH, poiLight.color, saturate(poiLight.nDotL));
            #else
                finalSpecular += calculateNewSpecular(specularMap.rgb, _SmoothnessFrom, realisticAlbedo, _SpecularTint, _SpecularMetallic, _SpecularSmoothness * specularMap.a, poiLight.dotNH, poiLight.dotLH, poiLight.color, poiLight.attenuation);
            #endif
        }
            ...
            {
                finalSpecular += AnisotropicSpecular(_SpecWhatTangent, _AnisoUseTangentMap, _SpecularSmoothness, _Spec2Smoothness, _AnisoSpec1Alpha, _AnisoSpec2Alpha, _SpecularTint, _SpecularMetallic, specularMap, poiLight.color, poiLight.direction, poiLight.halfDir, poiLight.nDotL);
                finalSpecular *= _SpecularTint;
            }
        #endif
        ...
        if (_EnableSpecular1)
        {
            ...
            if(_SpecularType1 == 1) // Realistic
            {
                ...
                #ifdef FORWARD_BASE_PASS
                    finalSpecular1 = calculateNewSpecular(specularMap1.rgb, _SmoothnessFrom1, realisticAlbedo1, _SpecularTint1, _SpecularMetallic1, _SpecularSmoothness1 * specularMap1.a, poiLight.dotNH, poiLight.dotLH, poiLight.color, poiLight.lightMap);
                #else
                    finalSpecular1 = calculateNewSpecular(specularMap1.rgb, _SmoothnessFrom1, realisticAlbedo1, _SpecularTint1, _SpecularMetallic1, _SpecularSmoothness1 * specularMap1.a, poiLight.dotNH, poiLight.dotLH, poiLight.color, poiLight.attenuation);
                #endif
            }
            UNITY_BRANCH
            if(_SpecularType1 == 2) // Toon
            {
                ...
                finalSpecular *= _SpecularTint1;
            }
            UNITY_BRANCH
            if (_SpecularType1 == 3) // anisotropic
            {
                finalSpecular1 = AnisotropicSpecular(_SpecWhatTangent1, _AnisoUseTangentMap1, _SpecularSmoothness1, _Spec2Smoothness1, _AnisoSpec1Alpha1, _AnisoSpec2Alpha1, _SpecularTint1, _SpecularMetallic1, specularMap1, poiLight.color, poiLight.direction, poiLight.halfDir, poiLight.nDotL);
                finalSpecular *= _SpecularTint1;
            }
                ...
                // Non Important Lights
                    ...
                    for (int index = 0; index < 4; index ++)
                    {
                        ...
                        if (_SpecularType == 1) // Realistic
                        {
                            finalSpecular += calculateNewSpecular(specularMap1.rgb, _SmoothnessFrom1, realisticAlbedo1, _SpecularTint1, _SpecularMetallic1, _SpecularSmoothness1 * specularMap1.a, poiLight.vDotNH[index], poiLight.vDotLH[index], poiLight.vColor[index], poiLight.vAttenuationDotNL[index]);
                        }
                    }
                #endif
            #endif
