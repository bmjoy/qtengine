Shader ".poiyomi/Toon/Simple/Cutout"
{
    Properties
    {
        ...
        _Clip ("Alpha Cuttoff", Range(0, 1.001)) = 0.01.5
        [HideInInspector][ToggleUI]_MainAlphaToCoverage ("Alpha To Coverage", Float) = 1
        ...
        */
        ...
        //[ToggleUI] _LightingUseShadowRamp ("Use Shadow Ramp", Float) = 0
        ...
        */
        ...
        [ToggleUI]_SSSInvertThicknessMap ("Invert Thickness", Float) = 0
        ...
        */
        ...
        [ToggleUI]_DitheringDistanceEnabled ("Distance Dithering", Float) = 0
